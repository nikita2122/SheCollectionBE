...
namespace SheCollectionBE.Migrations
{
    ...
    partial class SheCollectionContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SheCollectionBE.DB_Models.DbBackup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SheCollectionBE.Models.EmployeeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmployeeTypeId = 1,
                            EmployeeTypeDescription = "hair dresser",
                            EmployeeTypeName = "braider"
                        });
                });
            ...
            modelBuilder.Entity("SheCollectionBE.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductCategoryId = 1,
                            ProductCategoryDescription = "hair care items",
                            ProductCategoryName = "hair care",
                            imgUrl = ""
                        },
                        new
                        {
                            ProductCategoryId = 2,
                            ProductCategoryDescription = "nail care items",
                            ProductCategoryName = "nail care",
                            imgUrl = ""
                        });
                });
            ...
            modelBuilder.Entity("SheCollectionBE.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ServiceCategoryId = 1,
                            ServiceCategoryDescription = "Braiding or extending",
                            ServiceCategoryName = "Hair platting",
                            imgUrl = ""
                        });
                });
            ...
            modelBuilder.Entity("SheCollectionBE.Models.ServiceTable", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DurationMax = 10f,
                            DurationMin = 5f,
                            ServiceDescription = " ext",
                            ServiceName = "Hair extending",
                            ServicePicture = "",
                            ServicePrice = 499.99m,
                            ServiceTypeId = 1
                        });
                });
            ...
            modelBuilder.Entity("SheCollectionBE.Models.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServiceTypeId = 1,
                            ServiceCategoryId = 1,
                            ServiceTypeName = "Hair extending",
                            imgUrl = ""
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SheCollectionBE.Models.UserTable", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Picture = "",
                            UserName = "Admin",
                            UserPassword = "jr3s59rncvdb4YEDu7HkbH/cFzfANGXg61rsp6X7h1A=",
                            UserRoleId = 1
                        });
                });
